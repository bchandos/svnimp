class PopperBox extends HTMLElement {
  constructor() {
    ...
    if (this.dataset.externalCss) {
      externalLinkElem = document.createElement("link");
      externalLinkElem.setAttribute("rel", "stylesheet");
      externalLinkElem.setAttribute("href", this.dataset.externalCss);
    }
    ...
    if (externalLinkElem) {
      shadow.appendChild(externalLinkElem);
    }
  }
